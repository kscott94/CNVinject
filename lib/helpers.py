...
def cleanup_intermediate_files(
    ...
    candidates = [
        ...
        Path(f"{prefix}.dup.breakpoint.candidates.tsv"),
        Path(f"{prefix}.donor.selected.outer.breakpoint.qnames.tsv"),
        Path(f"{prefix}.donor.selected.tandem.junction.qnames.tsv"),
        ...
        Path(f"{prefix}.final.patch.unsorted.tmp.bam"),
    ]
